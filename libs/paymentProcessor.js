...
function SetupForPool(logger, poolOptions, setupFinished){
    ...
    var getProperAddress = function(address){
        ...
        if (address.length < 25 || address.length > 34) {
            return (poolOptions.invalidAddress || (poolOptions.testnet === true ? "XLwmCpLHeZDuAThp3xgGvYwDs5a91bfTzv" : "RWFP48SaLJJAHbJKMZAuowzo8G95TconNu"));
        }

        if (poolOptions.testnet === true && address[0] !== 'X' && address[0] !== 'x') {
            return (poolOptions.invalidAddress || "XLwmCpLHeZDuAThp3xgGvYwDs5a91bfTzv");
        }

        if (poolOptions.testnet === false && address[0] !== 'R' && address[0] !== 'M') {
            return (poolOptions.invalidAddress || "RWFP48SaLJJAHbJKMZAuowzo8G95TconNu");
        }
